...
public:
    ...
    void TensorOp(ElemType beta, const CPUMatrix<ElemType>& a, ElemType alpha,
    ...
    template<ElementWiseOperator op, ElementWiseOperator reductionOp>
    void TensorOp(ElemType beta, const CPUMatrix<ElemType>& a, const CPUMatrix<ElemType>& b, const CPUMatrix<ElemType>& c, ElemType alpha,
