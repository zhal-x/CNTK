...
public:
    ...
    void TensorOp(ElemType beta, const GPUMatrix<ElemType>& a, ElemType alpha,
    ...
    template <ElementWiseOperator op, ElementWiseOperator reductionOp>
    void TensorOp(ElemType beta, const GPUMatrix<ElemType>& a, const GPUMatrix<ElemType>& b, ElemType alpha,
    ...
    template <ElementWiseOperator op, ElementWiseOperator reductionOp>
    void TensorOp(ElemType beta, const GPUMatrix<ElemType>& a, const GPUMatrix<ElemType>& b, const GPUMatrix<ElemType>& c, ElemType alpha,
