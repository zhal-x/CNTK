...
public:
    ...
    void TensorOp(ElemType beta, const Matrix<ElemType>& a, ElemType alpha,
    ...
    template<ElementWiseOperator op, ElementWiseOperator reductionOp>
    void TensorOp(ElemType beta, const Matrix<ElemType>& a, const Matrix<ElemType>& b, ElemType alpha,
    ...
    template<ElementWiseOperator op, ElementWiseOperator reductionOp>
    void TensorOp(ElemType beta, const Matrix<ElemType>& a, const Matrix<ElemType>& b, const Matrix<ElemType>& c, ElemType alpha,
