...
public:
    ...
    ComputationNodePtr CTCWithSoftmax(const ComputationNodePtr label, const ComputationNodePtr prediction, size_t blankNum, int delayConstraint, const std::wstring nodeName = L"");
