...
void BlockRandomizerInstantiateTest(bool prefetch)
{
    ...
    auto randomizer = make_shared<BlockRandomizer>(0, SIZE_MAX, mockDeserializer, prefetch, false, false);
}
...
BOOST_AUTO_TEST_CASE(CheckGetCurrentCursorForRandomizers)
{
    ...
    auto blockRandomizer = make_shared<BlockRandomizer>(0, randomizationWindow, deserializer, true, false, false);
...
BOOST_AUTO_TEST_CASE(CheckSetCurrentCursorForRandomizers)
{
    ...
    auto expectedBlock = make_shared<BlockRandomizer>(0, randomizationWindow, deserializer, true, false, false);
    auto expectedNo = make_shared<NoRandomizer>(deserializer, false);

    auto underTestBlock = make_shared<BlockRandomizer>(0, randomizationWindow, deserializer, true, false, false);
...
BOOST_AUTO_TEST_CASE(RandRollbackToEarlierEpochBetweenSweeps)
{
    ...
    auto randomizer = make_shared<BlockRandomizer>(0, randomizationWindow, deserializer, true, false, false);
...
void BlockRandomizerOneEpochWithChunks1Test(bool prefetch)
{
    ...
    auto randomizer = make_shared<BlockRandomizer>(0, 4, mockDeserializer, prefetch, false, false);
...
void BlockRandomizerOneEpochWithChunks2Test(bool prefetch)
{
    ...
    auto randomizer = make_shared<BlockRandomizer>(0, 18, mockDeserializer, prefetch, false, false);
...
void BlockRandomizerChaosMonkeyTest(bool prefetch)
{
    ...
    auto randomizer = make_shared<BlockRandomizer>(0, windowSize, mockDeserializer, prefetch, false, false);
