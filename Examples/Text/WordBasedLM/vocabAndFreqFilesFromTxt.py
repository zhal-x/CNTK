...
def write_vocab_and_frequencies(word2count, vocab_file_path, freq_file_path, word2count_file_path):
...
word2count = count_words_in_file("data/tinyshakespeare.txt")
write_vocab_and_frequencies(word2count, "vocab.txt", "freq.txt", "word2freq.txt")